...
| **Practice** | 148 multiple-choice questions, scored, with the reason for each answer | Drilling the facts |
...
It covers 99 questions across the ten Process Safety categories: Risk Management,
...
**Practice** is the fourth mode in `LOFT-Process-Safety.html` &mdash; 148 multiple-choice
...
- Pick a topic or take the lot; 10, 20, 40 or all 148. Questions and options are shuffled.
