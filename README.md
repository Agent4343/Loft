...
| **Practice** | 159 multiple-choice questions, scored, with the reason for each answer | Drilling the facts |
...
**Practice** is the fourth mode in `LOFT-Process-Safety.html` &mdash; 159 multiple-choice
...
- Pick a topic or take the lot; 10, 20, 40 or all 159. Questions and options are shuffled.
